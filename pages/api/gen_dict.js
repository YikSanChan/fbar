// https://github.com/upzhaoyu/Chinese2pinyin/blob/master/dict/pinyin_dict_notone.js
const pinyinDict = {
  a: "阿啊呵腌嗄吖锕",
...
const dictByFirstChar = {};
for (const [key, value] of Object.entries(pinyinDict)) {
  const c = key.charAt(0);
  const s = dictByFirstChar[c] == undefined ? "" : dictByFirstChar[c];
  // only often seen
  dictByFirstChar[c] = s + value.substring(0, FIRST_N);
}

export default (req, res) => {
  res.status(200).json(dictByFirstChar);
};
